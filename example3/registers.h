...
#define FMC_IS_POWERDOWN_MODE_BANK2 (FMC->SDSR & (2UL << FMC_SDRTR_MODES2_2Bits)) == (2UL << FMC_SDRTR_MODES2_2Bits)
// Bank 1
...
#define FMC_IS_POWERDOWN_MODE_BANK1 (FMC->SDSR & (2UL << FMC_SDRTR_MODES1_2Bits)) == (2UL << FMC_SDRTR_MODES1_2Bits)
// TIM register bits
